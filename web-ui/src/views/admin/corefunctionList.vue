    ...
    <basic-container>
      <el-container>
        <el-header class="menu-header">
          <el-button-group>
            <el-button
              v-permission="['corefunction.save']"
              type="primary"
              icon="el-icon-plus"
              size="small"
      ...
      <el-container>
        ...
        <el-main>
          <el-form
            ...
            <el-form-item label="功能ID" style="width:300px">
              <el-input
                v-model="form.id"
                :disabled="true"/>
            </el-form-item>
            <el-form-item label="功能编号" prop="code" required style="width:300px">
              <el-input
                v-model="form.code"
                :disabled="formGrade"/>
            </el-form-item>
            <el-form-item label="功能名称" prop="label" required style="width:300px">
              <el-input
                v-model="form.label"
                :disabled="formGrade"/>
            </el-form-item>
            <el-form-item label="请求路径" style="width:300px">
              <el-input
            ...
            <el-form-item :label="$t('类型')" prop="type" required>
              <el-select v-model="form.type" class="filter-item" style="width:220px" >
                <el-option label="导航" value="1">导航</el-option>
                <el-option label="菜单" value="2">菜单</el-option>
                <el-option label="按钮" value="3">按钮</el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
              <el-button
...
<script>
import { fetchFunctionList, saveData, delData } from '@/api/corefunction'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchFunctionList(this.listQuery).then(response => {
